...
%---------------------------------------------------------
\begin{cvparagraph}
    Publications are categorized and listed in reversed chronological order. The dates are based on the publication time. If unavailable, the submission date on arXiv is used instead.
\end{cvparagraph}
