...
<div style="line-height: 1.5; font-size: 25px; font-weight: bold; text-indent: 0; margin-top: 30px; margin-bottom: -25px;">第一篇文章</div>
...
<br>从投稿到拒稿只用了两个星期，效率还是很快的。不过令人心寒的不是被拒稿，而是在拒稿的同时还要把我的文章说的一无是处，实在是给了刚刚进入科研领域的我一点小小的震撼。
